...
| --- | --- | --- | --- | --- | --- | --- |
| 4 | 검색 자동완성 | GET | `/api/search/autocomplete` | 시작 전 | 시작 전 | N |
| 5 | 인기 검색 키워드 | GET | `/api/search/trending` | 시작 전 | 시작 전 | N |
| 72 | 최근 검색기록 조회 | GET | `api/recent` | 완료 | 시작 전 | N |
| 73 | 최근 검색기록 추가 | POST | `api/recent` | 완료 | 시작 전 | N |
| 74 | 최근 검색기록 삭제 | DELETE | `api/recent` | 완료 | 시작 전 | N |
| 75 | 통합 검색 (장소 + 코스) | GET | `/api/search` | 시작 전 | 시작 전 | N |
