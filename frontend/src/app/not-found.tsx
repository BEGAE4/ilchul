    ...
    <div className="flex flex-col min-h-dvh bg-white relative overflow-hidden">
      ...
      <div className="relative flex-1 flex flex-col items-center justify-center p-8 text-center">
        <motion.div
          ...
          className="w-24 h-24 bg-primary-50 rounded-full flex items-center justify-center mb-8 border-2 border-primary-100"
        >
          <MapPinOff size={48} className="text-primary-400" />
        </motion.div>
        ...
        >
          ...
          <p className="text-sm text-gray-500 leading-relaxed mb-10">
            ...
            이동되었을 수 있어요.
            <br />
            <span className="text-primary-500 font-medium">새로운 여행을 시작해보는 건 어떨까요?</span>
          </p>
        </motion.div>
        ...
        >
          <button
            onClick={() => router.push('/')}
            className="w-full bg-primary-500 text-white font-bold py-3.5 rounded-xl shadow-lg shadow-primary-200 active:scale-[0.98] transition-transform flex items-center justify-center gap-2"
          >
            <Home size={18} />
            홈으로 돌아가기
          </button>
