...
import com.begae.backend.user.oauth2.KakaoUserInfo;
...
public class KakaoUserDetailsService extends DefaultOAuth2UserService {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        KakaoUserInfo kakaoUserInfo = new KakaoUserInfo(oAuth2User.getAttributes()); // 사용자 정보 객체 담기
        ...
        return new KakaoUserDetails(String.valueOf(user.getUserEmail()),
