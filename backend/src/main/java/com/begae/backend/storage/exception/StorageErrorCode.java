...
public enum StorageErrorCode implements ErrorCode {
    ...
    TOO_LARGE_FILE_SIZE(HttpStatus.PAYLOAD_TOO_LARGE, "S002", "파일의 크기는 15MB를 초과할 수 없습니다."),
    ...
    EMPTY_KEY(HttpStatus.BAD_REQUEST, "S005", "이미지 key가 비어있습니다."),
    TOO_MANY_FILES(HttpStatus.BAD_REQUEST, "S006", "이미지는 한 요청에 최대 5장까지 업로드할 수 있습니다.");
